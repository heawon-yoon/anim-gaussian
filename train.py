...
def training_report(tb_writer, iteration, Ll1, loss, l1_loss, elapsed, testing_iterations, avatar : Avatar, renderFunc, renderArgs):
    if tb_writer:
    ...
    if iteration % 500 == 0 or iteration==1:
        ...
        if tb_writer:
            tb_writer.add_histogram("scene/opacity_histogram", avatar.gaussians.get_opacity, iteration)
            tb_writer.add_scalar('total_points', avatar.gaussians.get_xyz.shape[0], iteration)
        torch.cuda.empty_cache()
